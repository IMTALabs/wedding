...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Corinthia:wght@400;700&family=Fuzzy+Bubbles:wght@400;700&display=swap" rel="stylesheet">
    @livewireStyles
</head>
<body>
                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="display-t">
                        <div class="display-tc animate-box" data-animate-effect="fadeIn">
                            <h1 class="corinthia-bold">{{$wedding->groom_first_name}} &amp; {{$wedding->bride_first_name}}</h1>
                                    ...
                                    <div class="event-wrap animate-box">
                                        ...
                                        <div class="row mt-5">
                                            ...
                                            <div class="event-col">
                                                ...
                                                <span class="d-block mt-2 fs-4">{{\Carbon\Carbon::parse($event->event_date)->locale('vi')->translatedFormat('d F, Y')}}</span>
                                            </div>
                                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
                    ...
                    <p>Ở nơi xa xôi, phía sau những dãy núi chữ, cách xa miền Vokalia và Consonantia, những con chữ vô danh vẫn sống và kể câu chuyện của chúng tôi.</p>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
                    ...
                    <p>Ở nơi xa xôi, phía sau những dãy núi chữ, cách xa miền Vokalia và Consonantia, những ký ức ngọt ngào của chúng tôi vẫn luôn hiện hữu.</p>
                </div>
            </div>
...
{{--   Modal--}}
    ...
    <div class="position-fixed top-0 end-0 p-3 d-none" style="z-index: 9999" data-wish-toast-container>
        <div id="wishSuccessToast" class="toast align-items-center text-bg-success border-0 shadow-lg" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="d-flex">
