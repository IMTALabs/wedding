                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="hero-style1">
                                <span class="hero-subtitle" data-ani="slideindown"
                                      data-ani-delay="0.5s">December 29</span>
                ...
                <div class="col-lg-5">
                    <div class="about-content-wrap title-anim">
                        <div class="title-area mb-0">
                            ...
                            <p class="sec-text">Lorem ipsum dolor sit amet consectetur adipiscing elit sociosqu integer,
                                suscipit nascetur aliquet posuere aptent vehicula ligula pulvinar praesent.
                            </p>
                        </div>
    ...
    <div class="service-area-1 overflow-hidden">
        ...
        <div class="container">
            <div class="title-area text-center title-anim">
                ...
                <h2 class="sec-title">SOCIAL MIXERS</h2>
            </div>
            <div class="row gx-90 gy-40 justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="service-card title-anim">
                        ...
                        <div class="service-card_content">
                            <h4 class="service-card_title h5">Wedding Reception</h4>
                            <span class="service-card_time">03 PM - 04 PM</span>
                            <p class="service-card_text">Sunday, Sept. 18th 2022.
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card title-anim">
                        ...
                        <div class="service-card_content">
                            <h4 class="service-card_title h5">The Ceremony</h4>
                            <span class="service-card_time">04 PM - 05 PM</span>
                            <p class="service-card_text">Sunday, Sept. 18th 2022. Lymni Restaurant, 123 Francois
                                Street</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card title-anim">
                        ...
                        <div class="service-card_content">
                            <h4 class="service-card_title h5">Party Time</h4>
                            <span class="service-card_time">06 PM - 12 PM</span>
                            <p class="service-card_text">Sunday, Sept. 18th 2022. Rooftoop, 123 Terry Francois
                                Street</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="title-area title-anim">
                        ...
                        <h2 class="sec-title">WELCOME TO OUR WEDDING &
                            CONCEPT STUDIO</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-7 filter-item">
                    <div class="portfolio-thumb fade_left">
                        ...
                        <div class="portfolio-details">
                            <p>Miranda & Malena</p>
                            <h3><a href="project-details.html">Best Weeding Of The Year</a></h3>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <input type="text" class="form-control style-border" name="subdomain"
                                               id="domain" placeholder="Enter your subdomain
                                               @error('groom_name') is-invalid @enderror">
                                        <input type="text"
                                               class="form-control style-border w-50 @error('groom_name') is-invalid @enderror"
                                               value=".wedding.com"
                                               readonly>
