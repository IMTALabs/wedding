...
<html lang="en-US">
  <head>
    ...
    <title>Shared on THEMELOCK.COM - lavewell - Marriage Story HTML5 Template</title>
    ...
    <link
      ...
      type="image/png"
      sizes="56x56"
      href="{{ asset('templates/lavewell/assets/images/fav-icon/icon.png') }}"
    />
    <!-- bootstrap CSS -->
    <link
      rel="stylesheet"
      href="{{ asset('templates/lavewell/assets/css/bootstrap.min.css') }}"
      type="text/css"
      media="all"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ asset('templates/lavewell/assets/css/animate.css') }}"
      type="text/css"
      media="all"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ asset('templates/lavewell/assets/css/all.min.css') }}"
      type="text/css"
      media="all"
    />
    <!-- font-flaticon CSS -->
    <link
      rel="stylesheet"
      href="{{ asset('templates/lavewell/assets/css/flaticon.css') }}"
      type="text/css"
      media="all"
    />
    <!-- theme-default CSS -->
    <link
      rel="stylesheet"
      href="{{ asset('templates/lavewell/assets/css/theme-default.css') }}"
      type="text/css"
      media="all"
    />
    <!-- meanmenu CSS -->
    <link
      rel="stylesheet"
      href="{{ asset('templates/lavewell/assets/css/meanmenu.min.css') }}"
      type="text/css"
      media="all"
    />
    <!-- venobox CSS -->
    ...
    <link
      rel="stylesheet"
      href="{{ asset('templates/lavewell/assets/css/bootstrap-icons.css') }}"
      type="text/css"
      media="all"
    />
    <!-- magnific popup css -->
    <link
      rel="stylesheet"
      href="{{ asset('templates/lavewell/assets/css/magnific-popup.css') }}"
      type="text/css"
      media="all"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ asset('templates/lavewell/assets/css/style.css') }}"
      type="text/css"
      media="all"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ asset('templates/lavewell/assets/css/responsive.css') }}"
      type="text/css"
      media="all"
    />
  ...
  <body>
    ...
    <!--==================================================-->
    <!-- Start lavewell Main Menu Area -->
    <!--==================================================-->
    <div id="sticky-header" class="lavewell_nav_manu">
      <div class="container-fluid">
        <div class="row d-flex align-items-center">
          <div class="col-lg-2">
            <div class="logo cursor-scale">
              <a class="logo_img" href="index.html" title="lavewell">
                <img src="assets/images/logo.png" alt="logo" />
              </a>
              <a class="main_sticky" href="index.html" title="lavewell">
                <img src="assets/images/logo.png" alt="astute" />
              </a>
            </div>
          </div>
          <div class="col-lg-8">
            <nav class="lavewell_menu">
              <ul class="nav_scroll">
                <li>
                ...
                <li><a class="cursor-scale" href="#">portfolio</a>
                  <ul class="sub-menu">
                    <li><a href="portfolio.html">portfolio</a></li>
                    <li>
                      <a href="protfolio-details.html">portfolio Details</a>
                    </li>
                  </ul>
                </li>
                <li>
    ...
    <!--==================================================-->
    <!-- End lavewell Main Menu Area -->
    <!--==================================================-->

    <!--==================================================-->
    <!--start lavewell slider area-->
    <!--==================================================-->

    <section class="lavewell-slider-area">
      <div class="lavewell-slider-wrapper">
        <div class="swiper-container lavewell-slider-active">
          <div class="swiper-wrapper">
            <!-- slide item 1 -->
            <div class="swiper-slide">
              <div class="lavewell-slider-height">
                <div class="lavewell-slider-bg"></div>
                <div class="container">
                  <div class="row">
                    <div class="col-xl-12">
                      <div class="lavewell-slider-content text-center">
                        <div class="lavewell-slider-title-box cursor-scale">
                          <span class="lavewell-slider-sub-title"
                            >Save the date for the wedding of June 10,2024</span
                          >
                          <h1 class="lavewell-slider-title cursor-scale">
                            Muskan & Mursalin
                          </h1>
                        </div>
                        <div class="lavewell-slider-btn">
            ...
            <div class="swiper-slide">
              <div class="lavewell-slider-height">
                <div class="lavewell-slider-bg2"></div>
                <div class="container">
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="lavewell-slider-content text-center">
        ...
        <div class="lavewell-slider-arrow-box">
    ...
    <!--==================================================-->
    <!--end lavewell slider area-->
    <!--==================================================-->

    <!--==================================================-->
    <!--start  lavewell service area-->
    <!--==================================================-->
    <div class="service-area">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-6">
            <div class="single-service-box cursor-scale">
              <div class="service-thumb">
                <img src="assets/images/home-1/service-thumb.png" alt="thumb" />
              </div>
              <div class="service-content">
                <h5 class="service-sub-title">THE BRIDE</h5>
          ...
          <div class="col-lg-6 col-md-6">
            <div class="single-service-box box-2 cursor-scale">
              <div class="service-thumb">
                <img
              ...
              <div class="service-content">
                <h5 class="service-sub-title">THE GROOM</h5>
                <h1 class="service-title">
                  <a href="service-details.html"> Muskan Mariya</a>
                </h1>
                <p class="service-desc">
                  There are many variations of passages of Loremos Ipsum their a
                  available, but the majority have manum suffered is Ipsum Ipsum
    ...
    <!--==================================================-->
    <!--end  lavewell service area-->
    <!--==================================================-->

    <!--==================================================-->
    <!--start  lavewell counter area-->
    <!--==================================================-->
    <div class="coutner-area">
      <div class="container">
        <div class="row counter align-items-center">
          <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="single-counter-misson cursor-scale">
              <div class="counter-content">
                <h6 class="counter-sub-title">MISSING DAYS TO</h6>
                <h2 class="counter-title">Our Wedding</h2>
              </div>
            </div>
          </div>
          <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="counter-single-box text-left text-md-left cursor-scale">
              <div class="odometer-wrapper counter-box-title" data-count="359">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6">
            <div
              class="counter-single-box text-md-left cursor-scale"
            >
              <div class="odometer-wrapper counter-box-title" data-count="23">
                <h1 class="odometer"></h1>
              </div>
              <div class="counter-desc">
                <p>HOURS</p>
          ...
          <div class="col-lg-2 col-md-4 col-sm-6">
            <div
              class="counter-single-box text-left text-md-left text-sm-left cursor-scale"
            >
              <div class="odometer-wrapper counter-box-title" data-count="59">
                <h1 class="odometer"></h1>
              </div>
              <div class="counter-desc">
                <p>MINUTES</p>
          ...
          <div class="col-lg-2 col-md-4 col-sm-6">
            <div
              class="counter-single-box text-left text-md-left text-sm-left cursor-scale"
            >
              <div class="odometer-wrapper counter-box-title" data-count="48">
                <h1 class="odometer"></h1>
              </div>
              <div class="counter-desc">
                <p>SECONDS</p>
    ...
    <!--==================================================-->
    <!--End lavewell counter area-->
    <!--==================================================-->

    <!--==================================================-->
    <!--start lavewell wedding event area-->
    <!--==================================================-->
    <div class="wedding-event-area">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="section-title text-center cursor-scale">
        ...
        <div class="row wedding-box align-items-center">
          <div class="col-lg-4">
            <div class="single-wedding-box cursor-scale">
              <div class="wedding-number">
                <span>01</span>
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="single-wedding-box last-child cursor-scale">
                  <div class="wedding-number">
                    <span>02</span>
                  </div>
                  <div class="wedding-title">
          ...
          <div class="col-lg-4">
            <div class="swiper wedding-active">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="wedding-thumb">
                    <img
              ...
              <div class="lavewell-wedding-arrow-box">
                <button
                  class="wedding-prev"
                  tabindex="0"
          ...
          <div class="col-lg-4 pl-0">
            <div class="single-wedding-box box-2 cursor-scale">
              <div class="wedding-number">
                <span>03</span>
              </div>
              <div class="wedding-title">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="single-wedding-box box-2 last-child cursor-scale">
                  <div class="wedding-number">
                    <span>04</span>
                  </div>
                  <div class="wedding-title">
        ...
        <div class="wedding-shape">
          <img src="assets/images/home-1/wedding-shape.png" alt="shape" />
        </div>
        <div class="wedding-shape2">
          <img src="assets/images/home-1/wedding-shape2.png" alt="shape" />
        </div>
      </div>
    </div>
    <!--==================================================-->
    <!--End lavewell wedding event area-->
    <!--==================================================-->

    <!--==================================================-->
    <!--start lavewell about area-->
    <!--==================================================-->
    <div class="about-area">
      <div class="container-fluid">
        <div class="row">
          <div class="col-xl-7 col-lg-6 pl-0">
            <div class="about-thumb">
              <img src="assets/images/home-1/about-thumb1.png" alt="thumb" />
            </div>
          </div>
          <div class="col-xl-5 col-lg-6">
            <div class="about-content">
              <div class="section-title text-left cursor-scale">
                <div class="section-sub-title">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 pr-0">
            <div class="about-thumb">
              <img src="assets/images/home-1/about-thumb4.jpg" alt="thumb" />
            </div>
          </div>
        </div>
      </div>
    ...
    <!--==================================================-->
    <!--start lavewell best friends area-->
    <!--==================================================-->
    <div class="best-friends-area">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="section-title text-center cursor-scale">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="single-best-friends">
              <div class="friends-thumb">
                <img src="assets/images/home-1/friends-thumb.png" alt="thumb" />
              </div>
              <div class="friends-content">
                ...
                <div class="friends-desc cursor-scale">
                  <p>
        ...
        <div class="friend-shape">
          <img src="assets/images/home-1/friends-shape.png" alt="shape" />
        </div>
        <div class="friend-shape2">
          <img src="assets/images/home-1/friend-shape2.png" alt="shape" />
        </div>
      </div>
    </div>

    <!--==================================================-->
    <!--End lavewell best friends area-->
    <!--==================================================-->

    <!--==================================================-->
    <!--start lavewell gallery area-->
    <!--==================================================-->
    ...
    <!--==================================================-->
    <!--End lavewell gallery area-->
    <!--==================================================-->

    <!--==================================================-->
    <!--start lavewell contact area-->
    <!--==================================================-->
    ...
    <!--==================================================-->
    <!--End lavewell contact area-->
    <!--==================================================-->

    <!--==================================================-->
    <!--start lavewell testimonial area-->
    <!--==================================================-->
    <div class="testimonial-area">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="swiper testi-active cursor-scale">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="testi-box">
              ...
              <div class="lavewell-testi-arrow-box">
                <button
                  class="testi-prev"
                  tabindex="0"
                  aria-label="Previous slide"
    ...
    <!--==================================================-->
    <!--End lavewell testimonial area-->
    <!--==================================================-->

    <!--==================================================-->
    <!--start lavewell blog area-->
    <!--==================================================-->
    <div class="blog-area">
      <div class="container">
        <div class="row">
    ...
    <!--==================================================-->
    <!--End lavewell blog area-->
    <!--==================================================-->

    <!--==================================================-->
    <!--start lavewell brand area-->
    <!--==================================================-->
    <div class="brand-area">
      <div class="container">
        <div class="row">
          <div class="swiper band-active cursor-scale">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="col-lg-2">
                  <div class="brand-box">
    ...
    <!--==================================================-->
    <!--End lavewell brand area-->
    <!--==================================================-->

    <!--==================================================-->
    <!-- Start lavewell Footer Area -->
    <!--==================================================-->
    ...
    <script src="{{ asset('templates/lavewell/assets/js/magnific-popup-js') }}"></script>
