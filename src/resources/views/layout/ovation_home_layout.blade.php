...
<head>
    ...
    <title>Ovation - Wedding & Event Photography HTML Template</title>
	...
	============================== -->
    <!-- Bootstrap -->
    <link rel="stylesheet" href="{{asset('assets/ovation-store-template/assets/css/bootstrap.min.css')}}">
    <!-- Fontawesome Icon -->
    <link rel="stylesheet" href="{{asset('assets/ovation-store-template/assets/css/all.min.css')}}">
    <!-- Magnific Popup -->
    <link rel="stylesheet" href="{{asset('assets/ovation-store-template/assets/css/magnific-popup.min.css')}}">
    <!-- Slick Slider -->
    <link rel="stylesheet" href="{{asset('assets/ovation-store-template/assets/css/slick.min.css')}}">
    <!-- Odometer -->
    <link rel="stylesheet" href="{{asset('assets/ovation-store-template/assets/css/odometer.css')}}">
    <!-- Theme Custom CSS -->
    <link rel="stylesheet" href="{{asset('assets/ovation-store-template/assets/css/style.css')}}">
...
<div class="preloader ">
    <div class="preloader-inner">
        <img src="{{asset('assets/ovation-store-template/assets/img/logo-white.svg')}}" alt="ovation">
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="index.html">Home 01 (Wedding)</a>
                                </li>
                                <li>
...
<footer class="footer-wrapper footer-layout1 overflow-hidden"
    ...
    <div class="shape-mockup footer1-shape2 jump-reverse" data-top="-10%" data-right="-10%">
        <img src="{{asset('assets/ovation-store-template/assets/img/normal/footer-1-shape2.png')}}" alt="img">
    </div>
    <div class="container">
...
============================== -->
<!-- Jquery -->
<script src="{{asset('assets/ovation-store-template/assets/js/vendor/jquery-3.6.0.min.js')}}"></script>
<!-- Slick Slider -->
<script src="{{asset('assets/ovation-store-template/assets/js/slick.min.js')}}"></script>
<!-- Bootstrap -->
<script src="{{asset('assets/ovation-store-template/assets/js/bootstrap.min.js')}}"></script>
<!-- Magnific Popup -->
<script src="{{asset('assets/ovation-store-template/assets/js/jquery.magnific-popup.min.js')}}"></script>
<!-- Counter Up -->
<script src="{{asset('assets/ovation-store-template/assets/js/jquery.counterup.min.js')}}"></script>
<!-- Range Slider -->
<script src="{{asset('assets/ovation-store-template/assets/js/jquery-ui.min.js')}}"></script>
<!-- odometer -->
<script src="{{asset('assets/ovation-store-template/assets/js/odometer.min.js')}}"></script>
<script src="{{asset('assets/ovation-store-template/assets/js/viewport.jquery.js')}}"></script>

<!-- Isotope Filter -->
<script src="{{asset('assets/ovation-store-template/assets/js/imagesloaded.pkgd.min.js')}}"></script>
<script src="{{asset('assets/ovation-store-template/assets/js/isotope.pkgd.min.js')}}"></script>
<!-- gsap -->
<script src="{{asset('assets/ovation-store-template/assets/js/gsap.min.js')}}"></script>
<script src="{{asset('assets/ovation-store-template/assets/js/ScrollSmoother.min.js')}}"></script>
<script src="{{asset('assets/ovation-store-template/assets/js/ScrollTrigger.min.js')}}"></script>
<script src="{{asset('assets/ovation-store-template/assets/js/SplitText.min.js')}}"></script>
