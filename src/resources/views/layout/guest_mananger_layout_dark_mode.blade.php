        ...
        <ul class="scrollable__content py-2">
            <li>
                ...
                <ul class="menu__sub-open">
                    ...
                    <li>
                        <a href="side-menu-dark-dashboard-overview-4.html" class="menu menu--active">
                            <div class="menu__icon"><i data-lucide="activity"></i></div>
...
<script>
    ...
    if (darkModeSwitcher) {
        ...
        darkModeSwitcher.addEventListener('click', function() {
            ...
            localStorage.setItem('guest_mananger_layout', isDarkModeActive); // Lưu trạng thái vào localStorage
