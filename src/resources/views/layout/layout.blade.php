...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset("assets/image/images-template/favicon.ico")}}" type="image/x-icon">

    <!-- Library CSS -->
    <link href="{{ asset("assets/css/css-template/glanz_library.css")}}" rel="stylesheet">

    <!-- Icons CSS -->
    <link href="{{ asset("assets/fonts-template/themify-icons.css")}}" rel="stylesheet">

    <!-- Theme CSS -->
    <link href="{{ asset("assets/css/css-template/glanz_style.css")}}" rel="stylesheet">
    ...
    <!-- Other Fonts -->
    <link href="{{ asset("assets/fonts-template/marsha/stylesheet.css")}}" rel="stylesheet">
...
<!-- JQuery -->
<script src="{{ asset("assets/js/js-template/jquery-1.12.4.min.js")}}"></script>
<!-- Library JS -->
<script src="{{ asset("assets/js/js-template/glanz_library.js")}}"></script>

<!-- Theme JS -->
<script src="{{ asset("assets/js/js-template/glanz_script.js")}}"></script>
